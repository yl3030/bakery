...
$("#btn1-1").click(function () {
	var num = 1;
	product1_1.amount = product1_1.amount + num;
	product1_1.total = product1_1.price * num;
...
$("#btn1-2").click(function () {
	var num = 1;
	product1_2.amount = product1_2.amount + num;
	product1_2.total = product1_2.price * num;
	document.getElementById("name1-2").innerHTML = product1_2.name;
	document.getElementById("amount1-2").innerHTML = product1_2.amount;
	document.getElementById("price1-2").innerHTML = product1_2.price;
...
$("#btn1-3").click(function () {
	var num = 1;
	product1_3.amount = product1_3.amount + num;
	product1_3.total = product1_3.price * num;
	document.getElementById("name1-3").innerHTML = product1_3.name;
	document.getElementById("amount1-3").innerHTML = product1_3.amount;
	document.getElementById("price1-3").innerHTML = product1_3.price;
...
$("#btn1-4").click(function () {
	var num = 1;
	product1_4.amount = product1_4.amount + num;
	product1_4.total = product1_4.price * num;
	document.getElementById("name1-4").innerHTML = product1_4.name;
	document.getElementById("amount1-4").innerHTML = product1_4.amount;
	document.getElementById("price1-4").innerHTML = product1_4.price;
...
$("#btn2-1").click(function () {
	var num = 1;
	product2_1.amount = product2_1.amount + num;
	product2_1.total = product2_1.price * num;
	document.getElementById("name2-1").innerHTML = product2_1.name;
	document.getElementById("amount2-1").innerHTML = product2_1.amount;
	document.getElementById("price2-1").innerHTML = product2_1.price;
...
$("#btn2-2").click(function () {
	var num = 1;
	product2_2.amount = product2_2.amount + num;
	product2_2.total = product2_2.price * num;
	document.getElementById("name2-2").innerHTML = product2_2.name;
	document.getElementById("amount2-2").innerHTML = product2_2.amount;
	document.getElementById("price2-2").innerHTML = product2_2.price;
...
$("#btn2-3").click(function () {
	var num = 1;
	product2_3.amount = product2_3.amount + num;
	product2_3.total = product2_3.price * num;
	document.getElementById("name2-3").innerHTML = product2_3.name;
	document.getElementById("amount2-3").innerHTML = product2_3.amount;
	document.getElementById("price2-3").innerHTML = product2_3.price;
...
$("#btn2-4").click(function () {
	var num = 1;
	product2_4.amount = product2_4.amount + num;
	product2_4.total = product2_4.price * num;
	document.getElementById("name2-4").innerHTML = product2_4.name;
	document.getElementById("amount2-4").innerHTML = product2_4.amount;
	document.getElementById("price2-4").innerHTML = product2_4.price;
...
$("#btn3-1").click(function () {
	var num = 1;
	product3_1.amount = product3_1.amount + num;
	product3_1.total = product3_1.price * num;
	document.getElementById("name3-1").innerHTML = product3_1.name;
	document.getElementById("amount3-1").innerHTML = product3_1.amount;
	document.getElementById("price3-1").innerHTML = product3_1.price;
...
$("#btn3-2").click(function () {
	var num = 1;
	product3_2.amount = product3_2.amount + num;
	product3_2.total = product3_2.price * num;
	document.getElementById("name3-2").innerHTML = product3_2.name;
	document.getElementById("amount3-2").innerHTML = product3_2.amount;
	document.getElementById("price3-2").innerHTML = product3_2.price;
...
$("#btn3-3").click(function () {
	var num = 1;
	product3_3.amount = product3_3.amount + num;
	product3_3.total = product3_3.price * num;
	document.getElementById("name3-3").innerHTML = product3_3.name;
	document.getElementById("amount3-3").innerHTML = product3_3.amount;
	document.getElementById("price3-3").innerHTML = product3_3.price;
...
$("#btn3-4").click(function () {
	var num = 1;
	product3_4.amount = product3_4.amount + num;
	product3_4.total = product3_4.price * num;
	document.getElementById("name3-4").innerHTML = product3_4.name;
	document.getElementById("amount3-4").innerHTML = product3_4.amount;
	document.getElementById("price3-4").innerHTML = product3_4.price;
...
$("#btn4-1").click(function () {
	var num = 1;
	product4_1.amount = product4_1.amount + num;
	product4_1.total = product4_1.price * num;
	document.getElementById("name4-1").innerHTML = product4_1.name;
	document.getElementById("amount4-1").innerHTML = product4_1.amount;
	document.getElementById("price4-1").innerHTML = product4_1.price;
...
$("#btn4-2").click(function () {
	var num = 1;
	product4_2.amount = product4_2.amount + num;
	product4_2.total = product4_2.price * num;
	document.getElementById("name4-2").innerHTML = product4_2.name;
	document.getElementById("amount4-2").innerHTML = product4_2.amount;
	document.getElementById("price4-2").innerHTML = product4_2.price;
...
$("#btn4-3").click(function () {
	var num = 1;
	product4_3.amount = product4_3.amount + num;
	product4_3.total = product4_3.price * num;
	document.getElementById("name4-3").innerHTML = product4_3.name;
	document.getElementById("amount4-3").innerHTML = product4_3.amount;
	document.getElementById("price4-3").innerHTML = product4_3.price;
...
$("#btn4-4").click(function () {
	var num = 1;
	product4_4.amount = product4_4.amount + num;
	product4_4.total = product4_4.price * num;
	document.getElementById("name4-4").innerHTML = product4_4.name;
	document.getElementById("amount4-4").innerHTML = product4_4.amount;
	document.getElementById("price4-4").innerHTML = product4_4.price;
...
$("#btn5-1").click(function () {
	var num = 1;
	product5_1.amount = product5_1.amount + num;
	product5_1.total = product5_1.price * num;
	document.getElementById("name5-1").innerHTML = product5_1.name;
	document.getElementById("amount5-1").innerHTML = product5_1.amount;
	document.getElementById("price5-1").innerHTML = product5_1.price;
...
$("#btn5-2").click(function () {
	var num = 1;
	product5_2.amount = product5_2.amount + num;
	product5_2.total = product5_2.price * num;
	document.getElementById("name5-2").innerHTML = product5_2.name;
	document.getElementById("amount5-2").innerHTML = product5_2.amount;
	document.getElementById("price5-2").innerHTML = product5_2.price;
...
$("#btn5-3").click(function () {
	var num = 1;
	product5_3.amount = product5_3.amount + num;
	product5_3.total = product5_3.price * num;
	document.getElementById("name5-3").innerHTML = product5_3.name;
	document.getElementById("amount5-3").innerHTML = product5_3.amount;
	document.getElementById("price5-3").innerHTML = product5_3.price;
...
$("#btn5-4").click(function () {
	var num = 1;
	product5_4.amount = product5_4.amount + num;
	product5_4.total = product5_4.price * num;
	document.getElementById("name5-4").innerHTML = product5_4.name;
	document.getElementById("amount5-4").innerHTML = product5_4.amount;
	document.getElementById("price5-4").innerHTML = product5_4.price;
